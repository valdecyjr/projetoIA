...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MOSTRAR = 3,                    /* MOSTRAR  */
  YYSYMBOL_PONTO_VIRGULA = 4,              /* PONTO_VIRGULA  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "MOSTRAR",
  "PONTO_VIRGULA", "STRING", "$accept", "programa", "comando", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* comando: MOSTRAR STRING PONTO_VIRGULA  */
#line 35 "parser.y"
        {
            printf("%s\n", (yyvsp[-1].str));
            free((yyvsp[-1].str));   /* libera a string alocada pelo lexer */
        }
